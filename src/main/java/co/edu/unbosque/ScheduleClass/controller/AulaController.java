...
// Fecha: 25/05/26
// Descripción: Controlador REST para la gestión de aulas en el sistema ScheduleClass.
//              Proporciona operaciones CRUD (Crear, Leer, Actualizar, Eliminar) sobre la entidad Aula.
